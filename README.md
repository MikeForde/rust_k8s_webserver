...
devcontainer (incl. Dockerfile) + Dockerfile (for OpenShift) adjusted such that it can be deployed with pre-compiled binary as an experiment in reducing compile time on OS.
